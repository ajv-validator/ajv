...
function getNodent() {
  /* jshint evil: true */
  try {
    // nodent declares functions not only on the top level, it won't work in node 0.10-0.12
...
function nodentTranspile(code) {
  return nodent.compile(code, ''/*filename*/, { promises: true, sourcemap: false }).code;
}
