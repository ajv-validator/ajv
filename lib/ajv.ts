...
import {AnySchemaObject} from "./types"
...
export default class Ajv extends AjvCore {
  _addVocabularies(): void {
    ...
    if (this.opts.dynamicRef) this.addVocabulary(dynamicVocabulary)
    ...
    if (this.opts.next) this.addVocabulary(nextVocabulary)
    if (this.opts.unevaluated) this.addVocabulary(unevaluatedVocabulary)
  }
