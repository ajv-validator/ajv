...
var compileSchema = require('./compile')
  ...
  , extendMetaSchema = require('./extendMeta')
...
Ajv.extendMetaSchema = extendMetaSchema;
Ajv.$dataMetaSchema = extendMetaSchema.$data; // deprecated
...
function addDraft6MetaSchema(self) {
  ...
  if (self._opts.$params) {
    var $paramSchema = require('./refs/$param.json');
    self.addMetaSchema($paramSchema, $paramSchema.$id, true);
  }
  if (self._opts.meta === false) return;
  var metaSchema = require('./refs/json-schema-draft-06.json');
  if (self._opts.$data || self._opts.$params)
    metaSchema = extendMetaSchema(metaSchema, META_SUPPORT_DATA, self._opts);
