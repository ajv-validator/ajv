...
All keywords can have an optional `metaSchema` property in their definitions. It is a schema against which the value of keyword will be validated during schema compilation.
