...
- [for arrays](keywords.html#keywords-for-arrays) - maxItems, minItems, uniqueItems, items, additionalItems
- [for objects](keywords.html#keywords-for-objects) - maxProperties, minproperties, required, properties, patternProperties, additionalProperties, dependencies
- [compound keywords](keywords.html#keywords-for-all-types) - enum, not, oneOf, anyOf, allOf
...
- [switch](keywords.html#switch-v5-proposal) - conditional validation with a sequence of if/then clauses
- [contains](keywords.html#contains-v5-proposal) - check that array contains a valid item
- [constant](keywords.html#constant-v5-proposal) - check that data is equal to some value
- [patternGroups](keywords.html#patterngroups-v5-proposal) - a more powerful alternative to patternProperties
- [patternRequired](keywords.html#patternrequired-v5-proposal) - like `required` but with patterns that some property should match.
- [formatMaximum, formatMinimum, formatExclusiveMaximum, formatExclusiveMinimum](keywords.html#formatmaximum--formatminimum-and-exclusiveformatmaximum--exclusiveformatminimum-v5-proposal) - setting limits for date, time, etc.
...
See [Defining custom keywords](custom.html) for details.
